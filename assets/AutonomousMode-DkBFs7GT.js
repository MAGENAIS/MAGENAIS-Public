import{S as e,_ as t,b as n,c as r,d as i,f as a,g as o,l as s,m as c,o as l,p as u,u as d,v as f,x as p,y as m}from"./main-SCDIEleY.js";import{n as h,r as g,t as _}from"./modes-DJUDz4W7.js";import{t as v}from"./Mode-Ch29-Hyc.js";import{t as y}from"./VoiceInput-CvaLwtaL.js";function b(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function x(e){return new Promise(t=>{let n=document.getElementById(`autonomousModelConsentModal`);n&&n.remove();let r=document.createElement(`div`);r.className=`modal-backdrop open`,r.id=`autonomousModelConsentModal`,r.innerHTML=`
