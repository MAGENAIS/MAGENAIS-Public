import{t as e}from"./Mode-2BXbs3UA.js";var t=[`JavaScript`,`TypeScript`,`HTML/CSS/JS (Web)`,`Python`,`Java`,`C`,`C++`,`C#`,`Go`,`Rust`,`PHP`,`Swift`,`Kotlin`,`SQL`,`Bash`],n=class extends e{activate(){this.renderControl(`
      <div class="field">
        ...
        <button class="ghost-btn small" id="mcpToolBtn" type="button" title="Run an MCP tool (e.g. read a file via Filesystem, inspect history via Git) and insert its result here as context" style="margin-top:6px;">🔌 MCP Tool</button>
      </div>
      <div class="field">
