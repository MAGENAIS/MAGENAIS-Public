import{A as e,B as t,C as n,F as r,J as i,K as a,S as o,T as s,U as c,b as l,d as u,q as d,w as f,x as p,y as m}from"./main-L10RF2M6.js";import{n as h,r as g,t as _}from"./modes-BTY6ZXLY.js";import{t as v}from"./Mode-BWw8Ks99.js";import{t as y}from"./VoiceInput-CvaLwtaL.js";import{t as b}from"./RosbridgeConnector-B1_aHESj.js";function x(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function S(e){return new Promise(t=>{let n=document.getElementById(`autonomousModelConsentModal`);n&&n.remove();let r=document.createElement(`div`);r.className=`modal-backdrop open`,r.id=`autonomousModelConsentModal`,r.innerHTML=`
