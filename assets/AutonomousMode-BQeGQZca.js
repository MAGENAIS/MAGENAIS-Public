import{C as e,E as t,I as n,J as r,S as i,T as a,V as o,W as s,Y as c,b as l,d as u,j as d,q as f,w as p,x as m}from"./main-Bb4QPNqr.js";import{n as h,r as g,t as _}from"./modes-BTY6ZXLY.js";import{t as v}from"./Mode-NaHOtIFU.js";import{t as y}from"./VoiceInput-CvaLwtaL.js";import{t as b}from"./RosbridgeConnector-B1_aHESj.js";function x(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function S(e){return new Promise(t=>{let n=document.getElementById(`autonomousModelConsentModal`);n&&n.remove();let r=document.createElement(`div`);r.className=`modal-backdrop open`,r.id=`autonomousModelConsentModal`,r.innerHTML=`
