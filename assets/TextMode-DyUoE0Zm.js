import{d as e}from"./main-DOB2GXWU.js";import{t}from"./Mode-BozB-yO3.js";import{i as n,r}from"./SymbiosisHandoff-DkpRyW56.js";import{t as i}from"./VoiceInput-CvaLwtaL.js";var a=class extends t{promptInput=null;activate(){this.renderControl(`
      <div class="field">
      ...
      <!-- MCP Tools sits at the very end of the control panel, immediately
           above Generate (same placement in the Coding tab). It was
           previously tucked into the mic row next to the prompt box, where
           it read as a voice-input control rather than the last optional
           step before running. Same id, same handler, same insert-into-
           prompt behavior — only its position moved. -->
      <button class="ghost-btn" id="mcpToolBtn" type="button" title="Run an MCP tool and insert its result into the prompt above as context" style="width:100%; margin-bottom:8px;">🔌 MCP Tools</button>
