import{t as e}from"./Mode-BgC9PqDe.js";import{t}from"./RosbridgeConnector-B1_aHESj.js";function n(e,t,n,r){let i={x:e*Math.cos(n),y:e*Math.sin(n)};return{elbow:i,endEffector:{x:i.x+t*Math.cos(n+r),y:i.y+t*Math.sin(n+r)}}}function r(e,t,n){let r=Math.hypot(n.x,n.y);if(r>e+t||r<Math.abs(e-t))return null;let i=(r*r-e*e-t*t)/(2*e*t),a=Math.acos(Math.min(1,Math.max(-1,i))),o=e+t*Math.cos(a),s=t*Math.sin(a),c=Math.atan2(n.y,n.x)-Math.atan2(s,o),l=Math.atan2(n.y,n.x)-Math.atan2(-s,o);return{elbowDown:[c,a],elbowUp:[l,-a]}}function i(e){return e*180/Math.PI}function a(e){return e*Math.PI/180}var o=[`Python (ROS 2 rclpy)`,`C++ (ROS 2 rclcpp)`,`MicroPython (Arduino/ESP32)`,`Python (raw, no framework)`],s=[`Humanoid`,`Manipulator`,`Quadruped`,`Mobile Robot`,`Industrial Robot`,`Drone`,`Custom`],c=[{label:`Walk`,prompt:`Walk forward 3 meters across a flat indoor floor, then stop.`},{label:`Navigate`,prompt:`Navigate from the current position to a marked waypoint, avoiding any obstacles detected along the way.`},{label:`Pick & Place`,prompt:`Pick up an object from location A and place it precisely at location B.`},{label:`Object Detection`,prompt:`Continuously detect and classify objects in the robot's camera view.`},{label:`Object Tracking`,prompt:`Track a specific moving object in view and keep it centered in the camera frame.`},{label:`Obstacle Avoidance`,prompt:`Move toward a goal position while detecting and avoiding both static and dynamic obstacles.`},{label:`Manipulation`,prompt:`Grasp an irregularly shaped object and reorient it to a target pose without dropping it.`},{label:`Inspection`,prompt:`Visually inspect a series of parts on a line and flag any that show visible defects.`},{label:`Human-Robot Interaction`,prompt:`Safely hand an object to a nearby person, waiting for their grip before releasing.`},{label:`Multi-Robot Coordination`,prompt:`Coordinate with a second robot so the two together carry a long object through a doorway.`}],l=[{name:`NVIDIA Isaac`,org:`NVIDIA`,status:`INSTALL REQUIRED`,note:`Robotics platform/SDK umbrella (perception, manipulation, navigation stacks).`,url:`https://developer.nvidia.com/isaac`},{name:`Isaac Sim`,org:`NVIDIA`,status:`INSTALL REQUIRED`,note:`Omniverse-based robot simulator. Local GPU install, not browser-runnable.`,url:`https://developer.nvidia.com/isaac/sim`},{name:`Isaac Lab`,org:`NVIDIA`,status:`INSTALL REQUIRED`,note:`GPU-accelerated robot learning framework built on Isaac Sim.`,url:`https://developer.nvidia.com/isaac/lab`},{name:`Isaac GR00T (N1.7)`,org:`NVIDIA`,status:`INSTALL REQUIRED`,note:`Open-weight humanoid foundation model — GA release, download from GitHub/Hugging Face and run locally (needs a GPU).`,url:`https://github.com/NVIDIA/Isaac-GR00T`},{name:`Gemini Robotics (VLA)`,org:`Google DeepMind`,status:`NO PUBLIC API`,note:`Whole-body vision-language-action model — early-access/trusted-tester partners only, no public API yet.`,url:`https://deepmind.google/models/gemini-robotics/`},{name:`Gemini Robotics-ER`,org:`Google DeepMind`,status:`API KEY REQUIRED`,note:`Genuinely wired in — enable "Google Gemini Robotics-ER" under Keys & Providers → Robotics and Task Planner will call it directly for image-grounded spatial reasoning.`,url:`https://ai.google.dev/gemini-api/docs/robotics-overview`},{name:`Gemini Robotics On-Device`,org:`Google DeepMind`,status:`NO PUBLIC API`,note:`On-device VLA for offline robots — trusted testers only.`,url:`https://deepmind.google/models/model-cards/gemini-robotics-on-device-2/`},{name:`Figure / Helix`,org:`Figure AI`,status:`NO PUBLIC API`,note:`Proprietary, in-house humanoid model — no public developer API.`,url:`https://www.figure.ai/`},{name:`1X / NEO`,org:`1X Technologies`,status:`NO PUBLIC API`,note:`Consumer humanoid platform — no public developer API.`,url:`https://www.1x.tech/`},{name:`Hugging Face robotics models`,org:`Hugging Face`,status:`READY`,note:`Open, browsable robotics/VLA model hub (e.g. LeRobot) — downloadable, no gatekeeping. For text-reasoning via the Inference API specifically, enable "Hugging Face (Robotics Q&A / Reasoning)" under Keys & Providers → Robotics.`,url:`https://huggingface.co/lerobot`}],u=[{name:`Boston Dynamics`,org:`Boston Dynamics`,status:`UNAVAILABLE`,note:`Commercial robot platforms (Atlas, Spot) — no public developer AI API.`,url:`https://bostondynamics.com/`},{name:`Unitree`,org:`Unitree Robotics`,status:`UNAVAILABLE`,note:`Quadruped/humanoid hardware maker — SDK is device-specific, not a hosted AI API.`,url:`https://www.unitree.com/`},{name:`ANYbotics`,org:`ANYbotics`,status:`UNAVAILABLE`,note:`Industrial quadruped inspection robots — no public AI API.`,url:`https://www.anybotics.com/`},{name:`Agility Robotics`,org:`Agility Robotics`,status:`UNAVAILABLE`,note:`Digit humanoid — no public AI API.`,url:`https://agilityrobotics.com/`},{name:`Sanctuary AI`,org:`Sanctuary AI`,status:`UNAVAILABLE`,note:`Humanoid + Carbon AI control system — no public API.`,url:`https://sanctuary.ai/`},{name:`Apptronik`,org:`Apptronik`,status:`UNAVAILABLE`,note:`Apollo humanoid — no public developer AI API of its own.`,url:`https://apptronik.com/`},{name:`Open VLA models`,org:`Open-source community`,status:`READY`,note:`OpenVLA and similar open vision-language-action models — downloadable weights, local inference.`,url:`https://openvla.github.io/`}],d=[{name:`NVIDIA Isaac Sim`,env:`Local`,license:`Free · Installation Required`,note:`GPU-accelerated Omniverse simulator, local install required.`,url:`https://developer.nvidia.com/isaac/sim`},{name:`NVIDIA Isaac Lab`,env:`Local`,license:`Free · Installation Required`,note:`Robot learning framework on top of Isaac Sim, local install required.`,url:`https://developer.nvidia.com/isaac/lab`},{name:`MuJoCo`,env:`Local`,license:`Open Source · Free`,note:`High-fidelity physics engine widely used for robot learning, maintained by Google DeepMind.`,url:`https://mujoco.org/`},{name:`MuJoCo Playground`,env:`Local`,license:`Open Source · Free (GPU required)`,note:`GPU-accelerated robot-learning framework (JAX/MJX) — Python install, not a browser demo despite the name.`,url:`https://playground.mujoco.org/`},{name:`MuJoCo WASM (official bindings)`,env:`Browser`,license:`Open Source · Free`,note:`DeepMind's own in-browser WASM build of MuJoCo — genuinely real, not yet wired into a working in-app preview (needs a build-tooling + runtime-testing pass this environment can't verify).`,url:`https://github.com/google-deepmind/mujoco/blob/main/wasm/README.md`},{name:`Gazebo`,env:`Local`,license:`Open Source · Free`,note:`ROS-ecosystem physics simulator, install required.`,url:`https://gazebosim.org/`},{name:`Webots`,env:`Local`,license:`Open Source · Free`,note:`Cross-platform open-source robot simulator, install required.`,url:`https://cyberbotics.com/`}],f=class extends e{activeTab=`plan`;inspectImageBase64=null;activate(){this.renderControl(this.controlMarkup()),this.wireTabs(),this.wirePlanTab(),this.wireCodeTab(),this.wireKinematicsTab(),this.wireInspectTab(),this.renderKinematicsPreview(.5,.4,a(45),a(-30))}deactivate(){}getTitle(){return`Robotics`}controlMarkup(){return`
      ...
      <div id="roboticsPlanPanel" class="field">
        ...
        <div class="chip-group" id="roboticsTaskTemplates" role="group" aria-label="Robot task templates">
          ${c.map(e=>`<button type="button" class="chip" data-task="${this.escapeHtml(e.label)}">${this.escapeHtml(e.label)}</button>`).join(``)}
        </div>
      ...
      <div id="roboticsIntelPanel" class="field" style="display:none;">
        ...
        ${this.renderIntelCards(l)}
        <details class="adv" style="margin-top:10px;"><summary>Future / roadmap ecosystems (not yet integrated)</summary><div class="adv-body">${this.renderIntelCards(u)}</div></details>
      </div>
    ...
    `}renderRosbridgePanel(){return`
      ...
      </div>`).join(``)}renderSimCards(){return d.map(e=>`
      <div style="padding:8px 10px; border:1px solid var(--line-bright); border-radius:var(--radius); margin-bottom:6px; display:flex; justify-content:space-between; align-items:center; gap:10px;">
        <div>
        ...
        <a href="${e.url}" target="_blank" rel="noopener noreferrer" class="ghost-btn">${e.env===`Browser`?`Launch`:`Open`}</a>
          ...
          </div>`),this.kernel.getStore().getActions().addHistoryEntry({mode:`robotics`,prompt:`[Inspect] ${i.length} detections`,result:JSON.stringify(i),resultType:`text`})}catch(e){this.renderError(e)}}wirePlanTab(){this.controlPanel.querySelector(`#roboticsPlanBtn`)?.addEventListener(`click`,()=>this.runGuarded(`roboticsPlanBtn`,()=>this.handlePlan()))}async handlePlan(){let e=this.controlPanel.querySelector(`#roboticsPlanInput`)?.value.trim();if(!e){alert(`Describe the robot task or goal.`);return}let t=this.controlPanel.querySelector(`#roboticsPlatform`)?.value||s[0];this.renderLoading(`Planning…`);let n=`You are an expert robotics systems engineer. Given the following task or goal for a ${t} robot, produce:\n1. A clear, numbered step-by-step task/motion plan.\n2. The key sensors/capabilities each step depends on (e.g. LIDAR, camera, IMU, gripper).\n3. Any safety or failure-mode considerations worth flagging.\n\nRobot platform: ${t}\nTask: "${e}"\n\nBe concrete and practical — this plan should be directly usable by an engineer implementing it, not generic advice.`,r=this.findRoboticsReasoningProvider();if(r){let t=this.kernel.getProviderRegistry().getAdapter(r.adapterId);if(t?.call)try{let i=await t.call(r,{prompt:n}),a=this.outputPanel.querySelector(`.stage`);a&&(a.innerHTML=`<div class="result-text">${this.renderMarkdown(String(i))}</div><p class="hint" style="margin-top:6px;">Generated via ${this.escapeHtml(r.name)} (Keys &amp; Providers → Robotics).</p>`,this.wireCodeCopyButtons(a)),this.kernel.getStore().getActions().addHistoryEntry({mode:`robotics`,prompt:`[Plan] ${e}`,result:String(i),resultType:`text`});return}catch(e){this.appendLog(`${r.name} failed (${e?.message||e}) — falling back to the regular text provider chain.`,`warn`)}}let i={id:`robotics-plan-`+Date.now(),name:`Robotics Task Planner`,graph:{nodes:[{id:`plan1`,type:`text`,label:`Task Planner`,config:{},inputs:{prompt:n},enabled:!0}],edges:[]},createdAt:Date.now(),updatedAt:Date.now()};try{let t=(await this.kernel.getWorkflowEngine().execute(i,{prompt:n},(e,t)=>this.appendLog(e,t))).finalOutput||`No output`,r=this.outputPanel.querySelector(`.stage`);r&&(r.innerHTML=`<div class="result-text">${this.renderMarkdown(t)}</div>`,this.wireCodeCopyButtons(r)),this.kernel.getStore().getActions().addHistoryEntry({mode:`robotics`,prompt:`[Plan] ${e}`,result:t,resultType:`text`})}catch(e){this.renderError(e)}}wireCodeTab(){this.controlPanel.querySelector(`#roboticsCodeBtn`)?.addEventListener(`click`,()=>this.runGuarded(`roboticsCodeBtn`,()=>this.handleCode()))}async handleCode(){let e=this.controlPanel.querySelector(`#roboticsCodeInput`)?.value.trim();if(!e){alert(`Describe what the robot code should do.`);return}let t=this.controlPanel.querySelector(`#roboticsCodeTarget`)?.value||o[0],n=this.controlPanel.querySelector(`#roboticsCodePlatform`)?.value||s[0];this.renderLoading(`Writing code…`);let r={id:`robotics-code-`+Date.now(),name:`Robotics Code Generator`,graph:{nodes:[{id:`code1`,type:`coding`,label:`Robotics Code Generator`,config:{language:t},inputs:{prompt:`Robot platform: ${n}\n\n${e}`},enabled:!0}],edges:[]},createdAt:Date.now(),updatedAt:Date.now()};try{let i=(await this.kernel.getWorkflowEngine().execute(r,{prompt:`Robot platform: ${n}\n\n${e}`},(e,t)=>this.appendLog(e,t))).finalOutput||`No output`,a=this.outputPanel.querySelector(`.stage`);a&&(a.innerHTML=`<div class="result-text">${this.renderMarkdown(i)}</div>`,this.wireCodeCopyButtons(a)),this.kernel.getStore().getActions().addHistoryEntry({mode:`robotics`,prompt:`[${t}] ${e}`,result:i,resultType:`text`})}catch(e){this.renderError(e)}}wireKinematicsTab(){this.controlPanel.querySelector(`#kForwardBtn`)?.addEventListener(`click`,()=>{let e=this.numVal(`#kL1`,.5),t=this.numVal(`#kL2`,.4),n=a(this.numVal(`#kTheta1`,0)),r=a(this.numVal(`#kTheta2`,0));this.renderKinematicsPreview(e,t,n,r)}),this.controlPanel.querySelector(`#kInverseBtn`)?.addEventListener(`click`,()=>{let e=this.numVal(`#kL1`,.5),t=this.numVal(`#kL2`,.4),n=this.numVal(`#kTargetX`,0),a=this.numVal(`#kTargetY`,0),o=r(e,t,{x:n,y:a}),s=this.outputPanel.querySelector(`.stage`);if(!s)return;if(!o){s.innerHTML=`<p class="hint">Target (${n}, ${a}) is unreachable with link lengths ${e}m + ${t}m — it's either too far away or inside the arm's dead zone.</p>`;return}let[c,l]=o.elbowDown,[u,d]=o.elbowUp;s.innerHTML=`
        <div class="result-text">
          <p><b>Inverse kinematics for target (${n}, ${a})</b></p>
          <p><b>Elbow-down solution:</b> θ1 = ${i(c).toFixed(2)}°, θ2 = ${i(l).toFixed(2)}°</p>
          <p><b>Elbow-up solution:</b> θ1 = ${i(u).toFixed(2)}°, θ2 = ${i(d).toFixed(2)}°</p>
        </div>`,this.renderKinematicsPreview(e,t,c,l,{x:n,y:a})})}numVal(e,t){let n=this.controlPanel.querySelector(e),r=parseFloat(n?.value||``);return Number.isFinite(r)?r:t}renderKinematicsPreview(e,t,r,i,a){let o=this.outputPanel.querySelector(`.stage`);if(!o)return;let{elbow:s,endEffector:c}=n(e,t,r,i),l=e=>({x:220+e.x*150,y:220-e.y*150}),u={x:220,y:220},d=l(s),f=l(c),p=a?l(a):null;o.innerHTML=`
      <div class="result-text">
