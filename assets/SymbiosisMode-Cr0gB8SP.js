const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/doc-CCbuFOQ5.js","assets/main-DOB2GXWU.js","assets/rolldown-runtime-Dd_uD5pT.js","assets/Environment-DAaQRBRU.js","assets/main-DV590_1a.css"])))=>i.map(i=>d[i]);
import{A as e,it as t,nt as n}from"./main-DOB2GXWU.js";import{n as r}from"./DocxExporter-DS2mDN3O.js";import{n as i}from"./PdfExporter-BjxPmJ74.js";import{t as a}from"./Mode-BozB-yO3.js";import{t as o}from"./SymbiosisHandoff-DkpRyW56.js";import{t as s}from"./StudioIcons-CY0XknFw.js";import{n as c}from"./ModelHandoff-C8-onsq0.js";import{t as l}from"./VoiceInput-CvaLwtaL.js";var u=[{id:`analyst`,label:`Analyst`,description:`Builds the strongest coherent analysis of the problem.`,instruction:`You are the Analyst. Develop the strongest coherent analysis of the problem. Identify assumptions, mechanisms, opportunities, and practical implications. Be concrete and specific.`},{id:`skeptic`,label:`Skeptic`,description:`Challenges the discussion's weakest reasoning.`,instruction:`You are the Skeptic. Challenge the previous contributions. Search for unsupported assumptions, contradictions, weak reasoning, missing evidence, edge cases, and alternative explanations. Be constructive, not merely contrarian.`},{id:`researcher`,label:`Researcher`,description:`Grounds the discussion in facts, context, and precedent.`,instruction:`You are the Researcher. Ground the discussion in relevant facts, context, prior art, and precedent. Clearly distinguish what is well-established from what is uncertain or unverifiable. Never fabricate sources or statistics.`},{id:`critic`,label:`Critic`,description:`Evaluates quality, coherence, and craft.`,instruction:`You are the Critic. Evaluate the quality, coherence, and craft of what has been proposed so far. Point out weak points precisely and suggest concrete improvements.`},{id:`innovator`,label:`Innovator`,description:`Generates unconventional but plausible new ideas.`,instruction:`You are the Innovator. Build on the discussion so far and generate unconventional but technically plausible new ideas or approaches that have not yet been considered.`},{id:`engineer`,label:`Engineer`,description:`Focuses on feasibility, implementation, and trade-offs.`,instruction:`You are the Engineer. Focus on technical feasibility, implementation details, architecture, and practical trade-offs. Flag anything that would be difficult, risky, or expensive to actually build.`},{id:`strategist`,label:`Strategist`,description:`Weighs options against goals and constraints.`,instruction:`You are the Strategist. Weigh the options against the stated goals and constraints. Clarify priorities, sequencing, and the likely long-term consequences of each path.`},{id:`risk-analyst`,label:`Risk Analyst`,description:`Surfaces risks, failure modes, and mitigations.`,instruction:`You are the Risk Analyst. Identify concrete risks, failure modes, and downside scenarios in what has been proposed, and suggest realistic mitigations.`},{id:`devils-advocate`,label:`Devil's Advocate`,description:`Argues the strongest opposing case.`,instruction:`You are the Devil's Advocate. Argue the strongest reasonable case AGAINST the current direction of the discussion, even if you personally find it compelling — the goal is stress-testing, not obstruction.`},{id:`creative`,label:`Creative`,description:`Explores imaginative or expressive directions.`,instruction:`You are the Creative. Explore imaginative, expressive, or unconventional directions for the topic. Prioritize originality while staying genuinely relevant to the discussion.`},{id:`synthesizer`,label:`Synthesizer`,description:`Integrates the discussion into a coherent whole.`,instruction:`You are the Synthesizer. Integrate the different perspectives raised so far into a coherent whole. Identify where they actually agree, where they genuinely conflict, and what the discussion still lacks.`}];function d(e){return u.find(t=>t.id===e)||u[0]}function f(e){let t=e.toLowerCase(),n=(...e)=>e.some(e=>t.includes(e));return n(`research`,`study`,`literature`,`evidence`,`paper`)?[`analyst`,`researcher`,`skeptic`,`synthesizer`,`critic`]:n(`controvers`,`debate`,`should we`,`ethic`,`policy`,`politic`)?[`analyst`,`skeptic`,`devils-advocate`,`researcher`,`synthesizer`]:n(`creative`,`story`,`design`,`brand`,`art`,`write a`)?[`creative`,`critic`,`innovator`,`synthesizer`,`analyst`]:n(`engineer`,`architecture`,`code`,`system`,`build`,`bug`,`performance`,`technical`)?[`engineer`,`skeptic`,`risk-analyst`,`innovator`,`critic`]:n(`decide`,`decision`,`choose`,`option`,`trade-off`,`tradeoff`,`strategy`,`invest`)?[`strategist`,`risk-analyst`,`analyst`,`devils-advocate`,`synthesizer`]:[`analyst`,`skeptic`,`innovator`,`researcher`,`synthesizer`]}function p(e){return e.getProviderManager().getProviders(`text`,!0).filter(e=>(e.noKeyNeeded||!!e.apiKey)&&!e.visionOnly).sort((e,t)=>(e.priority??50)-(t.priority??50)).map(e=>({id:e.id,name:e.name,model:e.defaultModel||``,adapterId:e.adapterId,noKeyNeeded:!!e.noKeyNeeded,inCooldown:n(e.health)}))}function m(e,t){return e.inCooldown===t.inCooldown?e.noKeyNeeded===t.noKeyNeeded?0:e.noKeyNeeded?1:-1:e.inCooldown?1:-1}function h(e){let t=p(e);return t.length>=2?{mode:`multi-provider`,usableProviders:t}:t.length===1?{mode:`single-provider`,usableProviders:t}:{mode:`none`,usableProviders:t}}var g=0;function _(){return g+=1,`sp_${Date.now()}_${g}_${Math.random().toString(36).slice(2,6)}`}function v(e,t,n){let r=d(e);return{id:_(),roleId:r.id,roleLabel:r.label,roleInstruction:r.instruction,providerId:t.id,providerName:t.name,model:t.model,enabled:!0,order:n}}function y(e,t){let n=f(t),{usableProviders:r,mode:i}=e;if(i===`none`||r.length===0)return[];if(i===`multi-provider`){let e=[...r].sort(m),t=Math.max(2,Math.min(e.length,n.length,6));return e.slice(0,t).map((e,t)=>v(n[t%n.length],e,t))}let a=r[0],o=Math.max(2,Math.min(n.length,3));return n.slice(0,o).map((e,t)=>v(e,a,t))}function b(e,t){if(t.length===0)return{participants:e,changed:!1};let n=new Map(t.map(e=>[e.id,e])),r=!1,i=new Set(e.filter(e=>{let t=n.get(e.providerId);return t&&!t.inCooldown}).map(e=>e.providerId)),a=()=>{let e=t.filter(e=>!e.inCooldown),n=e.length>0?e:t;return n.find(e=>!i.has(e.id))||n[0]};return{participants:e.map(e=>{let t=n.get(e.providerId);if(t&&!t.inCooldown)return e;let o=a();return i.add(o.id),r=!0,{...e,providerId:o.id,providerName:o.name,model:o.model}}),changed:r}}var x=8e3;function S(e){let t=e.kind===`human`?`Human`:e.roleLabel||`Participant`;return e.status===`skipped`?`${t} (round ${e.round}): [skipped]`:e.status===`error`?`${t} (round ${e.round}): [no response — ${e.error||`error`}]`:`${t} (round ${e.round}): ${e.content}`}function C(e){let t=e.transcript.filter(e=>e.status===`ok`).slice(-24).map(S).join(`

`);return t.length>x&&(t=t.slice(t.length-x)),t||`(no prior discussion yet — you are opening the discussion)`}function w(e,t){return[`Topic: ${e.topic}`,``,t.roleInstruction,``,e.mode===`single-provider`?`Note: the other participants below are different reasoning roles running on this same underlying model, not separate AI systems.`:``,`Discussion rules:`,...[`Answer the current problem directly.`,`Consider the previous participants' responses below.`,`Add something genuinely useful — do not simply repeat the transcript.`,`Challenge weak reasoning when appropriate, but stay constructive.`,`Clearly distinguish known information from your own uncertainty or speculation.`,`Never fabricate evidence, sources, or statistics.`,`Keep your response focused — a few well-developed paragraphs, not an exhaustive essay.`].map(e=>`- ${e}`),``,`Discussion so far:`,C(e),``,`Now provide the ${t.roleLabel}'s contribution for round ${e.currentRound}.`].join(`
`)}function T(e){let t=e.trimEnd();return!(!t||/[.!?"')\]}]\s*$/.test(t)||/```\s*$/.test(t)||/\|\s*$/.test(t)&&/^\s*\|.*\|\s*$/.test(t.split(`
`).pop()||``))}var E=2;async function D(e,t,n,r){let i=``,a=n;for(let o=0;o<=E;o++){let s=await e.call(t,{prompt:a},r),c=(typeof s==`string`?s:s?.text??s?.finalOutput??String(s)).trim();if(i=i?`${i}\n${c}`:c,!T(c)||o===E)break;a=`${n}\n\n---\nYou already wrote the following; it was cut off before you finished. Continue EXACTLY where you left off — do not repeat any earlier text, do not add a preamble like "continuing" or "sure":\n\n${i}`}return i}async function O(e,n,r,i){let a=e.getProviderManager(),o=e.getProviderRegistry(),s=a.getProviders(`text`,!1).find(e=>e.id===r.providerId);if(!s)return{ok:!1,error:`Provider "${r.providerName}" is no longer configured. Reconfigure this participant or remove it.`};if(!s.enabled||!(s.noKeyNeeded||s.apiKey))return{ok:!1,error:`Provider "${r.providerName}" is currently disabled or missing an API key.`};let c=o.getAdapter(s.adapterId);if(!c||!c.call)return{ok:!1,error:`Provider "${r.providerName}" has no callable adapter.`};let l=w(n,r),u=4096,d=r.model?{model:r.model,maxTokens:u,log:i||(()=>{})}:{maxTokens:u,log:i||(()=>{})},f=t.newRequestId(),p=Date.now();try{let e=await D(c,s,l,d);return!e||!e.trim()?(t.event({requestId:f,provider:r.providerName,model:r.model,providerType:`text`,failureReason:`Empty response`}),{ok:!1,error:`Empty response from ${r.providerName}.`}):(t.event({requestId:f,provider:r.providerName,model:r.model,providerType:`text`,winner:!0,latencyMs:Date.now()-p}),{ok:!0,content:e.trim()})}catch(e){return t.event({requestId:f,provider:r.providerName,model:r.model,providerType:`text`,failureReason:e?.message||String(e),latencyMs:Date.now()-p}),{ok:!1,error:e?.message||String(e)}}}var k=14e3;function A(e){let t=e.transcript.filter(e=>e.status===`ok`).map(e=>`[Round ${e.round}] ${e.kind===`human`?`Human`:e.roleLabel}: ${e.content}`).join(`

`),n=t.length>k?`...(earlier discussion omitted for length)...

`+t.slice(t.length-k):t,r=e.mode===`single-provider`?`IMPORTANT: All participants in this discussion are different reasoning ROLES run on the SAME underlying provider/model, not independent AI systems. Never write phrases like "two AI models agreed" or "independent models" — instead say things like "two distinct reasoning roles from the same provider/model produced these perspectives."`:`These participants are genuinely different AI providers/models — you may describe agreement or disagreement between them as such.`;return[`Summarize the following multi-participant discussion on the topic: "${e.topic}".`,r,`Produce the summary using exactly these section headings, each as a markdown "## " heading:`,`## Executive Summary`,`## Main Discussion`,`## Key Arguments`,`## Points of Agreement`,`## Points of Disagreement`,`## Important Ideas`,`## Open Questions`,`## Recommended Next Steps`,`## Human Contributions`,``,`Only use information actually present in the transcript below. Do not invent facts, sources, or contributions that are not there.`,``,`Transcript:`,n].join(`
`)}async function j(e,n,r){let i=n.participants.filter(e=>e.enabled);if(i.length===0)return{ok:!1,error:`No enabled participants to generate a summary with.`};let a=e.getProviderRegistry(),o=e.getProviderManager(),s=A(n),c=``;for(let e of i){let n=o.getProviders(`text`,!1).find(t=>t.id===e.providerId);if(!n||!n.enabled||!(n.noKeyNeeded||n.apiKey)){c=`Provider "${e.providerName}" is unavailable.`;continue}let i=a.getAdapter(n.adapterId);if(!i?.call){c=`Provider "${e.providerName}" has no callable adapter.`;continue}try{let a=6e3,o=e.model?{model:e.model,maxTokens:a,log:r||(()=>{})}:{maxTokens:a,log:r||(()=>{})},l=t.newRequestId(),u=Date.now(),d=await D(i,n,s,o);if(d&&d.trim())return t.event({requestId:l,provider:e.providerName,model:e.model,providerType:`text`,winner:!0,latencyMs:Date.now()-u}),{ok:!0,content:d.trim()};t.event({requestId:l,provider:e.providerName,model:e.model,providerType:`text`,failureReason:`Empty response`}),c=`Empty response from ${e.providerName}.`}catch(e){c=e?.message||String(e)}}return{ok:!1,error:c||`Unable to generate a summary.`}}function M(e){return e.kind===`human`?`human:${e.id}`:`ai:${e.round}:${e.participantId}`}function N(e){let t=new Map,n=[];for(let r of e.transcript){let e=M(r);t.has(e)||n.push(e),t.set(e,r)}return n.map(e=>t.get(e))}function P(){return{entrySignatures:new Map,roleHolder:new Map}}function F(e){return`[data-entry-key="${e.replace(/"/g,`\\"`)}"]`}function I(e,t,n,r){if(!e.querySelector(`.field[id^="symRound-"]`)&&n.entrySignatures.size>0)return null;let i=N(t);i.length>0&&e.querySelector(`#symTranscriptEmpty`)?.remove();let a=new Map;for(let e of i)e.participantId&&a.set(e.participantId,e.id);let o=[];for(let t of i){let i=M(t);if(n.entrySignatures.get(i)===t.timestamp)continue;let s=!!t.participantId&&a.get(t.participantId)===t.id;if(s&&t.participantId){let r=n.roleHolder.get(t.participantId);r&&r!==i&&e.querySelector(F(r))?.removeAttribute(`id`),n.roleHolder.set(t.participantId,i)}let c=r(t,s),l=e.querySelector(F(i)),u;if(l)l.outerHTML=c,u=e.querySelector(F(i));else{let n=e.querySelector(`#symRound-${t.round}`);n||=(e.insertAdjacentHTML(`beforeend`,`<div class="field" id="symRound-${t.round}"><p class="field-label">Round ${t.round}</p></div>`),e.querySelector(`#symRound-${t.round}`));let r=new Set(Array.from(n.children));n.insertAdjacentHTML(`beforeend`,c),u=Array.from(n.children).find(e=>!r.has(e))??null}u&&o.push(u),n.entrySignatures.set(i,t.timestamp)}return o}function L(e,t){t.entrySignatures.clear(),t.roleHolder.clear();let n=N(e),r=new Map;for(let e of n)e.participantId&&r.set(e.participantId,e.id);for(let e of n){let n=M(e);t.entrySignatures.set(n,e.timestamp),e.participantId&&r.get(e.participantId)===e.id&&t.roleHolder.set(e.participantId,n)}}function R(e){return new Date(e).toLocaleString()}function z(e){let t=`**${e.kind===`human`?`Human`:`${e.roleLabel} (${e.providerName}${e.model?` / `+e.model:``})`}** — round ${e.round}, ${R(e.timestamp)}`;if(e.status===`skipped`)return`${t}\n\n_Skipped._`;if(e.status===`error`)return`${t}\n\n_No response — ${e.error||`error`}._`;let n=e.assetRef?`\n\n_Reference: ${e.assetRef.label} (${e.sourceTab||e.assetRef.assetType})_`:``;return`${t}\n\n${e.content}${n}`}function B(e){let t=[];t.push(`# ${e.title}`),t.push(``),t.push(`**Topic:** ${e.topic||`(none stated)`}`),t.push(`**Date:** ${R(e.createdAt)} (last updated ${R(e.updatedAt)})`),t.push(`**Mode:** ${e.mode===`multi-provider`?`Multi-Provider Council`:`Single-Provider Multi-Role Council`}`),t.push(`**Status:** ${e.status}`),t.push(``),t.push(`## Participants`),t.push(``);for(let n of e.participants)t.push(`- **${n.roleLabel}** — ${n.providerName}${n.model?` / `+n.model:``}${n.enabled?``:` (disabled)`}`);e.mode===`single-provider`&&(t.push(``),t.push(`_Only one provider/model is available for this project. These are different reasoning roles from the same provider/model, not independent AI systems._`)),t.push(``),e.summary&&(t.push(`## Summary`),t.push(``),t.push(e.summary),t.push(``)),t.push(`## Full Transcript`),t.push(``);let n=N(e),r=Array.from(new Set(n.map(e=>e.round))).sort((e,t)=>e-t);for(let e of r){t.push(`### Round ${e}`),t.push(``);for(let r of n.filter(t=>t.round===e))t.push(z(r)),t.push(``)}return t.join(`
`)}function V(e){return e.replace(/[^a-z0-9\-_ ]/gi,``).trim().replace(/\s+/g,`-`).slice(0,60)||`symbiosis-project`}async function H(e,t){let n=V(e.title),a=B(e);switch(t){case`docx`:return{blob:await r(e.title,a),filename:`${n}.docx`};case`pdf`:return{blob:await i(e.title,a),filename:`${n}.pdf`};case`md`:return{blob:new Blob([a],{type:`text/markdown`}),filename:`${n}.md`};case`txt`:{let e=a.replace(/^#{1,6}\s*/gm,``).replace(/\*\*/g,``);return{blob:new Blob([e],{type:`text/plain`}),filename:`${n}.txt`}}case`json`:return{blob:new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),filename:`${n}.json`}}}var U=[{modelId:`magenais.decision-score`,icon:`⚖`,label:`DecisionScore`,verb:`Evaluate independently`},{modelId:`magenais.pattern-sense`,icon:`🔬`,label:`PatternSense`,verb:`Analyze as evidence`},{modelId:`magenais.anomaly-mind`,icon:`⚠`,label:`AnomalyMind`,verb:`Challenge as suspicious data`}];function W(e,t,n){let r=(t.content||``).trim();if(!r)return;let i={sourceTab:`Symbiosis`,modelId:n,label:t.sourceLabel||`Symbiosis · ${t.roleLabel||`transcript entry`}`,nlHint:r};c(e,i)}var G=class t extends a{view=`list`;currentProjectId=null;isRunning=!1;stopRequested=!1;pendingHandoffBanner=null;pendingAttachmentRef=null;transcriptRenderState=P();renderedDiscussionProjectId=null;get store(){return this.kernel.getSymbiosisStore()}activate(){let e=o();e&&(this.pendingHandoffBanner=e);let t=this.store.getActiveProject();t&&t.status!==`archived`?(this.currentProjectId=t.id,this.view=t.participants.length===0?`configure`:`discussion`):this.view=`list`,this.render()}deactivate(){}getTitle(){return`Symbiosis`}onReselect(){this.render()}render(){switch(this.renderControl(this.controlMarkup()),this.wireControl(),this.view){case`list`:this.renderListView();break;case`create`:this.renderCreateView();break;case`configure`:this.renderConfigureView();break;case`discussion`:this.renderDiscussionView()}}controlMarkup(){let e=this.currentProjectId?this.store.getProject(this.currentProjectId):void 0,t=this.store.getProjects().filter(t=>t.id!==e?.id);return`
      <div class="field">
...
`),r=prompt(`Add to which project?\n${n}`,`1`),i=t[r?parseInt(r,10)-1:-1];i&&(this.store.appendTranscriptEntry(i.id,{round:i.currentRound||1,kind:`human`,content:e.content,timestamp:Date.now(),status:`ok`,sourceTab:e.sourceTab,assetRef:e.assetRef}),this.store.setActiveProject(i.id),this.pendingHandoffBanner=null,this.openProject(i.id))}))}renderCreateView(){this.renderOutput(`
    ...
    `),this.outputPanel.querySelector(`#symCreateCancel`)?.addEventListener(`click`,()=>{this.view=`list`,this.render()});let e=this.outputPanel.querySelector(`#symCreateConfirm`);e&&this.guardClick(e,`Creating…`,()=>{let e=document.getElementById(`symTitleInput`)?.value||``,t=document.getElementById(`symTopicInput`)?.value||``;if(!t.trim()){alert(`Add a topic or question for the council to discuss.`);return}let n=this.store.createProject(e||t.slice(0,60),t);this.currentProjectId=n.id,this.view=`configure`,this.render()})}renderConfigureView(){let e=this.currentProject();if(!e){this.view=`list`,this.render();return}let t=h(this.kernel),n=t.usableProviders;if(e.participants.length>0&&n.length>0){let{participants:t,changed:r}=b(e.participants,n);r&&(this.store.updateProject(e.id,{participants:t}),e.participants=t)}if(t.mode===`none`){this.renderOutput(`
        <div class="result-text symb-shell">
    ...
    `),this.wireConfigureView(e,n)}participantCardMarkup(e,t,n){let r=u.map(t=>`<option value="${t.id}" ${t.id===e.roleId?`selected`:``}>${t.label}</option>`).join(``),i=n.map(t=>`<option value="${t.id}" ${t.id===e.providerId?`selected`:``}>${this.escapeHtml(t.name)}${t.model?` — `+this.escapeHtml(t.model):``}</option>`).join(``);return`
    ...
    `),this.renderedDiscussionProjectId=e.id,L(e,this.transcriptRenderState),this.wireDiscussionView(e)}updateFastChangingRegions(e){let{round:t,roundHasStarted:n,canStart:r,canContinue:i,isPaused:a,noProvidersLeft:o,roundStatusLine:s}=this.computeDiscussionState(e),c=this.outputPanel.querySelector(`.save-bar.symb-row`);c&&(c.innerHTML=`
      ...
      `,e){let t=document.getElementById(`symHumanInput`);t&&(t.value=e)}}if(e.summary){let t=document.getElementById(`symSummarySection`),n=t?.querySelector(`.result-text`);n?n.innerHTML=this.renderMarkdown(e.summary):t||document.getElementById(`symExportBar`)?.insertAdjacentHTML(`beforebegin`,this.summaryMarkup(e))}t>0&&!this.outputPanel.querySelector(`#symJumpToLatest`)&&this.outputPanel.querySelector(`.result-text`)?.insertAdjacentHTML(`afterend`,`<button id="symJumpToLatest" class="ghost-btn small symb-jump-btn" title="Jump to the latest round">↓ Latest</button>`),this.wireFastRegions(e)}seatsStripMarkup(e,t){return`<div class="symb-seats">${e.participants.map((n,r)=>{let i=this.seatColor(r),a=[...e.transcript].reverse().find(e=>e.round===t&&e.participantId===n.id),o=`○`,s=`Pending`,c=`var(--ink-faint)`;return n.enabled?t===0?(o=`·`,s=`Seated`):a?.status===`ok`?(o=`✓`,s=`Responded`,c=`var(--moss)`):a?.status===`error`?(o=`✕`,s=`No response`,c=`var(--rust)`):a?.status===`skipped`?(o=`—`,s=`Skipped`):this.isRunning&&(o=`…`,s=`Thinking`,c=`var(--amber)`):(o=`—`,s=`Disabled`),`
        ...
        </div>`}).join(``)}<div class="symb-seat symb-seat-human"><div class="symb-seat-role">You</div><div class="hint" style="font-size:11px;">Human</div></div></div>`}transcriptMarkup(e){if(e.transcript.length===0)return`<p class="hint" id="symTranscriptEmpty">No turns yet. Press Start to begin round 1.</p>`;let t=N(e),n=Array.from(new Set(t.map(e=>e.round))).sort((e,t)=>e-t),r=new Map;for(let e of t)e.participantId&&r.set(e.participantId,e.id);return n.map(n=>`
    ...
    `).join(``)}entryMarkup(e,t,n=!1){let r=e.kind===`human`,i=!r&&n&&e.participantId?` id="symRole-${e.participantId}"`:``,a=e.participantId?t.participants.findIndex(t=>t.id===e.participantId):-1,o=r?`var(--ink-dim)`:this.seatColor(a>=0?a:0),s=r?`You`:this.escapeHtml(e.roleLabel||`Participant`),c=r?e.sourceTab?`via ${this.escapeHtml(e.sourceTab)}`:``:`${this.escapeHtml(e.providerName||``)}${e.model?` / `+this.escapeHtml(e.model):``}`,l,u=``;return e.status===`error`?(l=`<span style="color:var(--rust);">No response — ${this.escapeHtml(e.error||`error`)}</span>`,e.participantId&&(u=`
          ...
          </div>`)):e.status===`skipped`?l=`<span class="hint">Skipped.</span>`:(l=`<div class="result-text">${this.renderMarkdown(e.content)}</div>`,e.assetRef&&(u=`<div class="hint" style="margin-top:4px;">📎 ${this.escapeHtml(e.assetRef.label)} (${this.escapeHtml(e.sourceTab||e.assetRef.assetType)})</div>`),u+=`
        <div class="studio-quick-actions" style="margin-top:6px;">
          <span class="hint">Send to Model Hub:</span>
          ${U.map(t=>`<button class="ghost-btn small" data-symbiosis-model-send="${t.modelId}" data-entry-key="${this.escapeHtml(M(e))}" title="${this.escapeHtml(t.verb)}">${t.icon} ${this.escapeHtml(t.label)}</button>`).join(``)}
        </div>`),`
      <div class="symb-bubble-row ${r?`symb-bubble-row-human`:``}" data-entry-key="${this.escapeHtml(M(e))}"${i}>
