import{t as e}from"./Mode-PfuIg-TA.js";var t=[`JavaScript`,`TypeScript`,`HTML/CSS/JS (Web)`,`Python`,`Java`,`C`,`C++`,`C#`,`Go`,`Rust`,`PHP`,`Swift`,`Kotlin`,`SQL`,`Bash`],n=class extends e{activate(){this.renderControl(`
      <div class="field">
