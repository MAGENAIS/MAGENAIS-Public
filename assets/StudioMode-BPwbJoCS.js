const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DocxExporter-DI8gc63r.js","assets/main-L10RF2M6.js","assets/rolldown-runtime-Dd_uD5pT.js","assets/Environment-DAaQRBRU.js","assets/main-7vXz9lTj.css","assets/MarkdownBlocks-p0NGuu_h.js","assets/PdfExporter-B2w31W6N.js","assets/MarkdownToHtml-BiWYp94M.js","assets/MathRenderer-Cn5YnC66.js","assets/doc-BGBJ_TxO.js"])))=>i.map(i=>d[i]);
import{D as e,u as t}from"./main-L10RF2M6.js";import{t as n}from"./Mode-BWw8Ks99.js";var r=new class{apps=new Map;register(e){this.apps.has(e.id)&&console.warn(`StudioRegistry: app "${e.id}" already registered, overwriting.`),this.apps.set(e.id,e)}getAll(){return Array.from(this.apps.values())}getById(e){return this.apps.get(e)}getByCategory(e){return this.getAll().filter(t=>t.category===e)}search(e){let t=e.trim().toLowerCase();if(!t)return this.getAll();let n=t.split(/\s+/).filter(e=>e.length>1);if(n.length===0)return[];let r=[];for(let e of this.getAll()){let i=[e.title.toLowerCase(),e.description.toLowerCase(),e.id.toLowerCase(),...(e.keywords||[]).map(e=>e.toLowerCase())],a=i.some(e=>e.includes(t)),o=new Set(n.filter(e=>i.some(t=>t.includes(e)))).size+(a?10:0);o>0&&r.push({app:e,score:o})}return r.sort((e,t)=>t.score-e.score).map(e=>e.app)}};function i(e){r.register(e)}var a=[{id:`text`,title:`Text & Voice`,description:`Write, converse, translate, and reason with text & voice AI.`,category:`core`,icon:`text`,status:`available`,action:e=>e.openMode(`text`)},{id:`image`,title:`Image`,description:`Create and edit images with AI.`,category:`core`,icon:`image`,status:`available`,action:e=>e.openMode(`image`)},{id:`video`,title:`Video`,description:`Generate and process AI video.`,category:`core`,icon:`video`,status:`available`,action:e=>e.openMode(`video`)},{id:`audio`,title:`Audio & Music`,description:`Speech, music, podcasts, and voice conversation.`,category:`core`,icon:`audio`,status:`available`,action:e=>e.openMode(`audio`)},{id:`data`,title:`Data Analytics`,description:`Visualize and analyze data with AI-assisted insight.`,category:`core`,icon:`data`,status:`available`,action:e=>e.openMode(`data`),keywords:[`analytics`,`charts`,`spreadsheet`,`csv`]},{id:`doc`,title:`Documents`,description:`Analyze, summarize, translate, and compare documents.`,category:`core`,icon:`doc`,status:`available`,action:e=>e.openMode(`doc`),keywords:[`pdf`,`word`,`files`]},{id:`research`,title:`Research`,description:`AI-powered research and knowledge synthesis.`,category:`core`,icon:`research`,status:`available`,action:e=>e.openMode(`research`)},{id:`game`,title:`Game`,description:`Build interactive AI-generated games.`,category:`core`,icon:`game`,status:`available`,action:e=>e.openMode(`game`)},{id:`coding`,title:`Coding`,description:`AI pair-programming and code generation.`,category:`core`,icon:`coding`,status:`available`,action:e=>e.openMode(`coding`),keywords:[`code`,`programming`,`dev`]},{id:`vision`,title:`Vision`,description:`Image and camera understanding, OCR, and object detection.`,category:`core`,icon:`vision`,status:`available`,action:e=>e.openMode(`vision`),keywords:[`ocr`,`detect`,`camera`]},{id:`agents`,title:`Agents`,description:`Multi-step AI agents with planning and memory.`,category:`core`,icon:`agents`,status:`available`,action:e=>e.openMode(`agents`)},{id:`autonomous`,title:`Autonomous`,description:`Real-time perception and autonomous decision-making.`,category:`core`,icon:`autonomous`,status:`available`,action:e=>e.openMode(`autonomous`),keywords:[`robot`,`robotics`,`self-driving`,`car`,`drone`]},{id:`robotics`,title:`Robotics`,description:`Task/motion planning, ROS code generation, and kinematics — free & paid AI providers.`,category:`core`,icon:`robotics`,status:`available`,action:e=>e.openMode(`robotics`),keywords:[`robot`,`ros`,`kinematics`,`arm`]},{id:`quantum`,title:`Quantum`,description:`Design and simulate quantum circuits free, or run them on real IBM Quantum hardware.`,category:`core`,icon:`quantum`,status:`available`,action:e=>e.openMode(`quantum`),keywords:[`qubit`,`circuit`,`qiskit`,`ibm`]}],o=[{id:`problem`,title:`Problem Solver`,description:`Describe a real-world problem and let MAGENAIS determine the required capabilities and solution path.`,category:`intelligence`,icon:`problem`,status:`available`,action:()=>{},keywords:[`problem`,`solve`,`analyze`,`plan`,`goal`]},{id:`decision`,title:`Decision Intelligence`,description:`Compare alternatives using evidence, cost, risk, uncertainty, and expected outcomes.`,category:`intelligence`,icon:`decision`,status:`available`,action:()=>{},keywords:[`decision`,`decide`,`compare`,`choose`,`tradeoff`,`alternatives`]},{id:`knowledge`,title:`Knowledge`,description:`Explore what MAGENAIS already knows about your current project — documents, research, data, and results.`,category:`intelligence`,icon:`knowledge`,status:`available`,action:()=>{},keywords:[`knowledge`,`notes`,`wiki`,`sources`,`documents`,`research`]},{id:`verification`,title:`Verification`,description:`Check a claim or statement against supplied evidence and sources — Supported, Contradicted, or Unverified. Not a universal truth detector.`,category:`intelligence`,icon:`verification`,status:`available`,action:()=>{},keywords:[`verify`,`fact-check`,`evidence`,`claim`,`contradiction`,`source`]},{id:`diagnosis`,title:`Diagnosis`,description:`Investigate why something is not working — weigh possible causes against evidence in a Hypothesis Table. Not a definitive answer.`,category:`intelligence`,icon:`diagnosis`,status:`available`,action:()=>{},keywords:[`diagnose`,`root cause`,`troubleshoot`,`debug`,`hypothesis`,`symptom`]},{id:`inspection`,title:`Inspection`,description:`Inspect an image, document, or data reading for anomalies and defects against an objective you define — never a certain result, only Possible/Likely/Detected/Not detected/Unable to determine.`,category:`intelligence`,icon:`inspection`,status:`available`,action:()=>{},keywords:[`inspect`,`defect`,`anomaly`,`vision`,`quality`]},{id:`optimization`,title:`Optimization`,description:`Improve a measurable objective under constraints — real arithmetic on Current vs Target when the numbers are there, structured trade-offs otherwise. Never a fake optimal value.`,category:`intelligence`,icon:`optimization`,status:`available`,action:()=>{},keywords:[`optimize`,`efficiency`,`cost`,`reduce`,`improve`,`throughput`]}],s=!1;function c(){s||(s=!0,[...a,...o].forEach(i))}var l={text:`<path d="M4 6h16M4 12h10M4 18h13"/>`,image:`<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="M21 16l-5-5-9 9"/>`,video:`<rect x="3" y="6" width="12" height="12" rx="2"/><path d="M15 10l6-3v10l-6-3"/>`,audio:`<path d="M9 18V6l9-2v12"/><circle cx="6.5" cy="18" r="2.5"/><circle cx="15.5" cy="16" r="2.5"/>`,data:`<path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/>`,doc:`<path d="M7 3h7l5 5v13a1 1 0 01-1 1H7a1 1 0 01-1-1V4a1 1 0 011-1z"/><path d="M14 3v5h5"/><path d="M9 13h6M9 17h6"/>`,research:`<circle cx="10.5" cy="10.5" r="6.5"/><path d="M20 20l-5.5-5.5"/>`,game:`<rect x="2" y="7" width="20" height="11" rx="4"/><path d="M7 10v4M5 12h4"/><circle cx="16" cy="10.5" r="1"/><circle cx="18.5" cy="13" r="1"/>`,coding:`<path d="M9 8l-5 4 5 4M15 8l5 4-5 4M13 5l-2 14"/>`,vision:`<path d="M2 12s3.6-6.5 10-6.5S22 12 22 12s-3.6 6.5-10 6.5S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>`,agents:`<circle cx="12" cy="8" r="3.5"/><path d="M4.5 20a7.5 7.5 0 0115 0"/><circle cx="19" cy="6" r="1.6"/><circle cx="5" cy="6" r="1.6"/>`,autonomous:`<rect x="3" y="10" width="18" height="9" rx="2"/><path d="M8 10V6a4 4 0 018 0v4"/><circle cx="8.5" cy="15" r="1.2"/><circle cx="15.5" cy="15" r="1.2"/>`,robotics:`<rect x="6" y="8" width="12" height="10" rx="2"/><circle cx="10" cy="13" r="1.3"/><circle cx="14" cy="13" r="1.3"/><path d="M12 8V5M9 5h6M4 12v3M20 12v3"/>`,quantum:`<circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none"/><ellipse cx="12" cy="12" rx="9" ry="3.6"/><ellipse cx="12" cy="12" rx="9" ry="3.6" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="9" ry="3.6" transform="rotate(120 12 12)"/>`,chart:`<path d="M4 20V4M4 20h16"/><path d="M7 16l4-5 3 3 5-7"/>`,config:`<circle cx="12" cy="12" r="3"/><path d="M12 3v2.5M12 18.5V21M21 12h-2.5M5.5 12H3M18.7 5.3l-1.8 1.8M7.1 16.9l-1.8 1.8M18.7 18.7l-1.8-1.8M7.1 7.1L5.3 5.3"/>`,problem:`<circle cx="12" cy="12" r="9"/><path d="M9.5 9a2.5 2.5 0 115 .7c-.4 1.1-2.5 1.4-2.5 3.3"/><circle cx="12" cy="17" r="0.6" fill="currentColor" stroke="none"/>`,decision:`<path d="M12 3v4M12 17v4M5 8l3 2M16 14l3 2M5 16l3-2M16 10l3-2"/><circle cx="12" cy="12" r="3.2"/>`,knowledge:`<path d="M4 5.5C4 4.7 4.7 4 6 4c3 0 5 1.2 6 2.4C13 5.2 15 4 18 4c1.3 0 2 .7 2 1.5v13c0-.8-.7-1.5-2-1.5-3 0-5 1.2-6 2.4V6.4"/>`,verification:`<path d="M12 3l7 3v6c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z"/><path d="M9 12l2 2 4-4"/>`,diagnosis:`<circle cx="11" cy="11" r="6.5"/><path d="M20 20l-4.5-4.5"/><path d="M8 11h2v3M10 8v.01"/>`,inspection:`<path d="M2 12s3.6-6.5 10-6.5S22 12 22 12s-3.6 6.5-10 6.5S2 12 2 12z"/><path d="M12 8.5v3.5l2 1.3"/>`,optimization:`<path d="M4 20V13M4 9V4M12 20v-3M12 13V4M20 20v-9M20 7V4M2 13h4M10 9h4M18 7h4"/>`,desktop:`<rect x="3" y="4" width="18" height="12" rx="2"/><path d="M8 20h8M12 16v4"/>`,search:`<circle cx="10.5" cy="10.5" r="6.5"/><path d="M20 20l-5.5-5.5"/>`,star:`<path d="M12 3.5l2.6 5.4 5.9.8-4.3 4.1 1 5.9-5.2-2.8-5.2 2.8 1-5.9-4.3-4.1 5.9-.8z"/>`,clock:`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2"/>`,plus:`<path d="M12 5v14M5 12h14"/>`,workflow:`<circle cx="5" cy="6" r="2.2"/><circle cx="19" cy="6" r="2.2"/><circle cx="12" cy="18" r="2.2"/><path d="M7 7l3.5 9M17 7l-3.5 9"/>`,history:`<path d="M3 12a9 9 0 109-9"/><path d="M3 4v5h5"/><path d="M12 8v4l3 2"/>`,ask:`<circle cx="12" cy="12" r="9"/><path d="M9.5 9a2.5 2.5 0 115 .7c-.4 1.1-2.5 1.4-2.5 3.3"/><circle cx="12" cy="17" r="0.6" fill="currentColor" stroke="none"/>`,lock:`<rect x="5" y="10" width="14" height="10" rx="2"/><path d="M8 10V7a4 4 0 018 0v3"/>`,app:`<rect x="4" y="4" width="7" height="7" rx="1.5"/><rect x="13" y="4" width="7" height="7" rx="1.5"/><rect x="4" y="13" width="7" height="7" rx="1.5"/><rect x="13" y="13" width="7" height="7" rx="1.5"/>`,link:`<path d="M14 4h6v6M20 4l-9 9M9 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2v-3"/>`,trash:`<path d="M4 7h16M9 7V4a1 1 0 011-1h4a1 1 0 011 1v3m-9 0 1 13a2 2 0 002 2h6a2 2 0 002-2l1-13"/><path d="M10 11v6M14 11v6"/>`,folder:`<path d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"/>`};function u(e,t=20){return`<svg viewBox="0 0 24 24" width="${t}" height="${t}" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${l[e]||l.app}</svg>`}function d(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function f(e,t,n,r){let i=document.getElementById(`askMagenaisGuideModal`);i&&i.remove();let a=n.slice(0,4);i=document.createElement(`div`),i.className=`modal-backdrop open`,i.id=`askMagenaisGuideModal`,i.innerHTML=`
    <div class="modal" style="max-width:480px;">
      <button class="modal-close" id="askGuideClose">×</button>
      <h3>${u(`ask`,16)} Ask MAGENAIS</h3>
        ...
        <div class="studio-mini-list" style="margin-bottom:14px;">
          ${a.map(e=>`
            <button class="studio-mini-item" data-open-id="${e.id}" title="${d(e.description)}">
              <span class="studio-mini-icon">${u(e.icon,15)}</span>
      ...
      <div class="studio-control">
        ...
        <div class="studio-section">
          ...
          <div class="studio-quick-actions">
            <button class="ghost-btn small" id="studioNewProjectBtn">${u(`plus`,13)} New Project</button>
            <button class="ghost-btn small" id="studioOpenProjectBtn">${u(`folder`,13)} Open Project</button>
            <button class="ghost-btn small" id="studioDeleteProjectBtn">${u(`trash`,13)} Delete Project</button>
            <button class="ghost-btn small" id="studioNewWorkflowBtn">${u(`workflow`,13)} New Workflow</button>
            <button class="ghost-btn small" id="studioOpenHistoryBtn">${u(`history`,13)} Open History</button>
          </div>
        </div>
        ...
        <div class="studio-section">
          ...
          <div class="studio-ask-row">
            ...
            <button class="ghost-btn small" id="studioAskBtn">${u(`ask`,13)}</button>
          </div>
    ...
    `,e.querySelectorAll(`.studio-tile`).forEach(e=>{e.addEventListener(`click`,()=>this.activateApp(e.dataset.appId))}),e.querySelectorAll(`.studio-tile-fav`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),this.toggleFavorite(e.dataset.favId)})})}categoryBodyMarkup(e){return`<div class="studio-grid" role="grid">${e.map(e=>this.tileMarkup(e)).join(``)}</div>`}tileMarkup(e){let t=this.favorites.includes(e.id),n=e.status===`available`||e.status===`experimental`,r=$[e.status]||e.status;return`
      <div class="studio-tile-wrap">
        <button class="studio-tile studio-status-${e.status}" data-app-id="${e.id}" role="gridcell"
          ...
          <span class="studio-tile-icon">${u(e.icon,22)}</span>
          ...
          ${n?``:`<span class="studio-tile-lock">`+u(`lock`,12)+`</span>`}
        </button>
      ...
      <div class="studio-intel-topbar">
        <div class="studio-intel-topbar-row">
          ...
          <div class="studio-intel-tabs" role="tablist" aria-label="Intelligence workspaces">${r.getByCategory(`intelligence`).filter(e=>e.status===`available`||e.status===`experimental`).map(t=>`
        <button type="button" class="studio-intel-tab ${t.id===e?`active`:``}" data-intel-tab="${t.id}"
          ...
          ${u(t.icon,14)}<span>${Q(t.title)}</span>
        </button>`).join(``)}</div>
        </div>
      ...
      <div class="studio-workspace">
        ...
        <div class="studio-workspace-header">
          <div>
            ...
            ${a?`<p class="studio-project-context">Project context: <b>${Q(a.name)}</b></p>`:``}
          </div>
        </div>
        ...
        <div class="studio-section">
          ...
          <textarea id="studioPsContext" rows="2" placeholder="Any extra detail, constraints, or requirements..." aria-label="Context and constraints">${Q(i)}</textarea>
        </div>
        <div class="studio-ps-actions">
          <button type="button" class="run-btn" id="studioPsAnalyze">${u(`problem`,14)} Analyze Goal</button>
        ...
        <div class="studio-result-card">
          ...
          <div class="result-text">${!i||i.loading?`<span class="hint">Asking your enabled AI provider for a suggestion…</span>`:i.error?`<span class="hint">Couldn't reach an AI provider (${Q(i.error)}) — enable one under Keys &amp; Providers.</span>`:Q(i.answer||``).replace(/\n/g,`<br>`)}</div>
        ...
        </div>`;let a=t[0].app,o=t.filter(e=>e.app.status===`available`||e.app.status===`experimental`),s=a.status===`available`||a.status===`experimental`?a:o[0]?.app,c=!this.kernel.getProviderManager().hasAnyUsableProvider(),l=t.map(({app:e})=>{let t=e.status===`available`||e.status===`experimental`,n=$[e.status]||e.status;return`
        ...
        </button>`}).join(``),d=o.length>1;return`
      <div class="studio-result-card">
        <p class="field-label">Goal</p>
        <p>${Q(e.goal)}</p>
        ...
        <div class="studio-capability-list">${l}</div>
        ...
        <p>Open <b>${Q(a.title)}</b>${a.status!==`available`&&a.status!==`experimental`?` (coming soon)`:``}</p>
        <div class="studio-ps-actions">
          ${s?`<button type="button" class="run-btn" id="studioPsOpenTop" data-open-id="${s.id}">Open ${Q(s.title)}</button>`:``}
        ...
        <div id="studioPsAiBlock">${this.problemSolverAiBlockMarkup(i)}</div>

        <p class="field-label" style="margin-top:14px;">Continue this result</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioPsSendDecision">${u(`decision`,13)} Send to Decision Intelligence</button>
          <button type="button" class="ghost-btn" id="studioPsSaveKnowledge">${u(`knowledge`,13)} Save to Knowledge</button>
        </div>
      ...
      <div class="studio-ai-suggestions">
        ...
        <div class="studio-ai-suggestions">
          <button type="button" class="ghost-btn small" id="studioPsAiAsk">${u(`ask`,13)} Get AI Answer</button>
      ...
      <div class="studio-workspace studio-workspace-wide">
        ...
        <div class="studio-section">
          ...
          ${i.length>0?`
            <div class="studio-mini-list" style="margin-top:4px;">
              ${i.map(e=>`<button type="button" class="studio-mini-item" data-attach-asset="${Q(e.name)}"><span class="studio-mini-title">+ ${Q(e.name)}</span></button>`).join(``)}
            </div>
        ...
        <div class="studio-ps-actions">
          <button type="button" class="run-btn" id="studioDecAnalyze">${u(`decision`,14)} Analyze Decision</button>
          <button type="button" class="ghost-btn" id="studioDecClear">Clear</button>
        </div>

        <div id="studioDecResult">${e?this.decisionViewMarkup(e):``}</div>
      </div>`,this.wireIntelligenceTopbar(t);let a=[[`question`,`studioDecQuestion`],[`alternatives`,`studioDecAlternatives`],[`criteria`,`studioDecCriteria`],[`constraints`,`studioDecConstraints`],[`context`,`studioDecContext`],[`evidence`,`studioDecEvidence`]],o=()=>{let e={...J};for(let[n,r]of a)e[n]=t.querySelector(`#`+r)?.value||``;return e};t.querySelector(`#studioDecAnalyze`)?.addEventListener(`click`,()=>this.runDecisionAnalysis(o())),t.querySelector(`#studioDecClear`)?.addEventListener(`click`,()=>{this.lastDecisionRaw=J,this.lastDecisionAnalysis=null,this.decisionAiSuggestions=null,this.decisionAiError=null,this.handoffNote=null,this.renderDecisionWorkspace()}),t.querySelectorAll(`[data-attach-asset]`).forEach(e=>{e.addEventListener(`click`,()=>{let n=t.querySelector(`#studioDecEvidence`);if(!n)return;let r=e.dataset.attachAsset,i=`Describe the claim from "${r}" here | ${r} | Unknown`;n.value=n.value?`${n.value}\n${i}`:i,n.focus()})});let s=t.querySelector(`#studioDecQuestion`);e&&e.kind!==`empty`&&this.wireDecisionResult(),(!e||e.kind===`empty`)&&s?.focus()}runDecisionAnalysis(e){this.handoffNote=null,this.lastDecisionRaw=e;let t=e.question.trim();if(!t){this.renderDecisionWorkspace({kind:`empty`}),this.outputPanel.querySelector(`#studioDecQuestion`)?.focus();return}let n=ae(e.alternatives),{criteria:r,rows:i}=pe(e.criteria,n),a=Te({question:t,alternatives:n,criteria:r,comparisonRows:i,constraints:oe(e.constraints),context:e.context.trim()||void 0,evidence:me(e.evidence)});this.lastDecisionAnalysis=a,this.decisionAiSuggestions=null,this.decisionAiError=null,this.kernel.getEventBus().emit(`studio:decisionAnalyzed`,{question:t,alternativeCount:n.length,criteriaCount:r.length,hasTable:a.hasComparisonTable}),this.renderDecisionWorkspace({kind:`result`,analysis:a})}decisionViewMarkup(e){return e.kind===`empty`?`
        <div class="studio-result-card studio-result-warn">
      ...
      </div>`}bulletListMarkup(e,t){return e.length===0?`<p class="hint">${this.escapeHtml(t)}</p>`:`<ul class="studio-bullet-list">${e.map(e=>`<li>${this.escapeHtml(e)}</li>`).join(``)}</ul>`}decisionResultMarkup(e){let{input:t}=e,n=!this.kernel.getProviderManager().hasAnyUsableProvider(),i=e.suggestedCapabilityId?r.getById(e.suggestedCapabilityId):null;return`
      <div class="studio-result-card">
        ...
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioDecResearch">${u(`research`,13)} Research This</button>
          <button type="button" class="ghost-btn" id="studioDecNewProject">${u(`plus`,13)} Create Project</button>
          ${i?`<button type="button" class="ghost-btn" id="studioDecOpenCapability" data-open-id="${i.id}">${u(i.icon,13)} Open ${this.escapeHtml(i.title)}</button>`:``}
        </div>

        <p class="field-label" style="margin-top:14px;">Continue this result</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioDecSendProblem">${u(`problem`,13)} Send to Problem Solver</button>
          <button type="button" class="ghost-btn" id="studioDecSaveKnowledge">${u(`knowledge`,13)} Save to Knowledge</button>
        </div>
      ...
      <div class="studio-ai-suggestions">
        <button type="button" class="ghost-btn small" id="studioDecAiAsk">${u(`ask`,13)} Get AI Suggestions</button>
...
`)){let e=i.trim();if(!e)continue;let a=e.replace(/:$/,``).toLowerCase();if(n[a]){r=n[a];continue}if(!r)continue;let o=e.replace(/^[-*•]\s*/,``).trim();o&&t[r].push(o)}return t}renderVerificationWorkspace(e){this.activeWorkspace=`verification`;let t=this.outputPanel.querySelector(`.stage`);if(!t)return;let n=this.lastVerificationRaw,r=this.kernel.getProjectManager().getCurrentProject(),i=(r?.assets||[]).filter(e=>e.type===`document`||e.type===`research`||e.type===`other`||e.type===`text`);t.innerHTML=`
      <div class="studio-workspace studio-workspace-wide">
        ${this.intelligenceTopbarMarkup(`verification`)}
        <div class="studio-workspace-header">
          <div>
            <div class="studio-workspace-title">${u(`verification`,20)} MAGENAIS Intelligence — Verification</div>
        ...
        <div class="studio-ps-actions">
          <button type="button" class="run-btn" id="studioVerAnalyze">${u(`verification`,14)} Verify</button>
        ...
        <div class="studio-result-card studio-result-warn">
          ...
          </div>`).join(``)}</div>`:`<p class="hint">No evidence was supplied for this claim.</p>`,o=e.relatedSources.length>0?`<p class="field-label" style="margin-top:14px;">Related project sources <span class="hint">(matched by name — not automatically counted as evidence)</span></p>${this.knowledgeSourcesListMarkup(e.relatedSources,5,!1)}`:``,s=e.contradictions.length>0?e.contradictions.map(e=>`
      ...
      <div class="studio-result-card">
        ...
        ${s}
        ${e.contradictions.length>0?`<div class="studio-ps-actions" style="margin-top:8px;"><button type="button" class="ghost-btn small" id="studioVerResearchFurther">${u(`research`,13)} Research Further</button></div>`:``}
        ...
        <p class="field-label" style="margin-top:14px;">Next actions</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioVerResearch">${u(`research`,13)} Research Further</button>
          <button type="button" class="ghost-btn" id="studioVerNewProject">${u(`plus`,13)} Create Project</button>
          ${i?`<button type="button" class="ghost-btn" id="studioVerOpenCapability" data-open-id="${i.id}">${u(i.icon,13)} Open ${Q(i.title)}</button>`:``}
        </div>

        <p class="field-label" style="margin-top:14px;">Continue this result</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioVerSendProblem">${u(`problem`,13)} Send to Problem Solver</button>
          <button type="button" class="ghost-btn" id="studioVerSaveKnowledge">${u(`knowledge`,13)} Save to Knowledge</button>
        </div>
      ...
      <div class="studio-ai-suggestions">
        <button type="button" class="ghost-btn small" id="studioVerAiAsk">${u(`ask`,13)} Get AI Assist</button>
...
`)){let e=o.trim();if(!e)continue;let s=e.replace(/:$/,``).toLowerCase();if(n[s]){r=n[s];continue}if(!r)continue;let c=e.replace(/^[-*•]\s*/,``).trim();c&&(r===`status`?i.push(c):r===`conclusion`?a.push(c):t[r].push(c))}return t.statusReading=i.length?i.join(` `):null,t.conclusion=a.length?a.join(` `):null,t}renderDiagnosisWorkspace(e){this.activeWorkspace=`diagnosis`;let t=this.outputPanel.querySelector(`.stage`);if(!t)return;let n=this.lastDiagnosisRaw,r=this.kernel.getProjectManager().getCurrentProject(),i=(r?.assets||[]).filter(e=>e.type===`document`||e.type===`research`||e.type===`other`||e.type===`text`||e.type===`image`||e.type===`data`);t.innerHTML=`
      <div class="studio-workspace studio-workspace-wide">
        ${this.intelligenceTopbarMarkup(`diagnosis`)}
        <div class="studio-workspace-header">
          <div>
            <div class="studio-workspace-title">${u(`diagnosis`,20)} MAGENAIS Intelligence — Diagnosis</div>
        ...
        <div class="studio-section">
          ...
          ${i.length>0?`
            <div class="studio-mini-list" style="margin-top:4px;">
              ${i.map(e=>`<button type="button" class="studio-mini-item" data-attach-diag-asset="${Q(e.name)}"><span class="studio-mini-title">+ ${Q(e.name)}</span></button>`).join(``)}
            </div>
        ...
        <div class="studio-ps-actions">
          <button type="button" class="run-btn" id="studioDiagAnalyze">${u(`diagnosis`,14)} Diagnose</button>
      ...
      </div>`}diagnosisResultMarkup(e){let{input:t}=e,n=!this.kernel.getProviderManager().hasAnyUsableProvider(),i=e.suggestedCapabilityId?r.getById(e.suggestedCapabilityId):null,a=[...t.symptoms.map(e=>`Symptom: ${e}`),...t.observations.map(e=>`Observed: ${e}`)],o=e.relatedSources.length>0?`<p class="field-label" style="margin-top:14px;">Related project sources <span class="hint">(matched by name — not automatically counted as evidence)</span></p>${this.knowledgeSourcesListMarkup(e.relatedSources,5,!1)}`:``,s=e.unmatchedEvidence.length>0?`<p class="field-label" style="margin-top:14px;">Unmatched evidence <span class="hint">(named a hypothesis not found in Possible Causes)</span></p>${this.bulletListMarkup(e.unmatchedEvidence.map(e=>`"${e.text}" — attached to "${e.hypothesis}"`),``)}`:``;return`
      <div class="studio-result-card">
        <div class="studio-caps-row" style="margin-top:0;">
        ...
        ${this.bulletListMarkup(a,`No symptoms or observed data were supplied.`)}
        ${o}
        ...
        <p class="field-label" style="margin-top:14px;">Next actions</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioDiagResearch">${u(`research`,13)} Research Further</button>
          <button type="button" class="ghost-btn" id="studioDiagNewProject">${u(`plus`,13)} Create Project</button>
          ${i?`<button type="button" class="ghost-btn" id="studioDiagOpenCapability" data-open-id="${i.id}">${u(i.icon,13)} Open ${Q(i.title)}</button>`:``}
        </div>

        <p class="field-label" style="margin-top:14px;">Continue this result</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioDiagSendProblem">${u(`problem`,13)} Send to Problem Solver</button>
          <button type="button" class="ghost-btn" id="studioDiagSaveKnowledge">${u(`knowledge`,13)} Save to Knowledge</button>
        </div>
      ...
      <div class="studio-ai-suggestions">
        <button type="button" class="ghost-btn small" id="studioDiagAiAsk">${u(`ask`,13)} Get AI Assist</button>
...
`)){let e=a.trim();if(!e)continue;let o=e.replace(/:$/,``).toLowerCase();if(n[o]){r=n[o];continue}if(!r)continue;let s=e.replace(/^[-*•]\s*/,``).trim();s&&(r===`summary`?i.push(s):t[r].push(s))}return t.summary=i.length?i.join(` `):null,t}renderInspectionWorkspace(e){this.activeWorkspace=`inspection`;let t=this.outputPanel.querySelector(`.stage`);if(!t)return;let n=this.lastInspectionRaw,r=this.kernel.getProjectManager().getCurrentProject(),i=(r?.assets||[]).filter(e=>e.type===`image`||e.type===`document`||e.type===`research`||e.type===`other`||e.type===`text`||e.type===`data`||e.type===`video`),a=this.kernel.getProviderManager().getVisionCapableProviders().length>0,o=this.inspectionAttachedInputs.filter(e=>e.kind===`image`),s=this.inspectionAttachedInputs.filter(e=>e.kind===`document`||e.kind===`sensor-data`||e.kind===`video`);t.innerHTML=`
      <div class="studio-workspace studio-workspace-wide">
        ${this.intelligenceTopbarMarkup(`inspection`)}
        <div class="studio-workspace-header">
          <div>
            <div class="studio-workspace-title">${u(`inspection`,20)} MAGENAIS Intelligence — Inspection</div>
        ...
        <div class="studio-section">
          ...
          ${o.map(e=>`<div class="file-chip"><span>${Q(e.name)}</span><button type="button" data-remove-insp-input="${Q(e.name)}" title="Remove">&times;</button></div>`).join(``)}
          ${a?``:`
        ...
        <div class="studio-section">
          ...
          ${s.filter(e=>e.kind===`document`).map(e=>`<div class="file-chip"><span>${Q(e.name)}</span><button type="button" data-remove-insp-input="${Q(e.name)}" title="Remove">&times;</button></div>`).join(``)}
        </div>
        ...
        ${i.length>0?`
          <div class="studio-section">
            ...
            <div class="studio-mini-list">
              ${i.map(e=>`<button type="button" class="studio-mini-item" data-attach-insp-asset="${Q(e.id)}"><span class="studio-mini-title">+ ${Q(e.name)} <span class="hint">(${Q(e.type)})</span></span></button>`).join(``)}
            </div>
        ...
        ${s.filter(e=>e.kind===`video`).map(e=>`<div class="file-chip"><span>${Q(e.name)} <span class="hint">(video, not analyzed)</span></span><button type="button" data-remove-insp-input="${Q(e.name)}" title="Remove">&times;</button></div>`).join(``)}
        ...
        <div class="studio-ps-actions">
          <button type="button" class="run-btn" id="studioInspAnalyze" ${this.inspectionAnalyzing?`disabled`:``}>${u(`inspection`,14)} ${this.inspectionAnalyzing?`Inspecting…`:`Inspect`}</button>
        ...
        </div>`:this.inspectionResultMarkup(e.analysis)}inspectionResultMarkup(e){let{input:t}=e,n=e.suggestedCapabilityId?r.getById(e.suggestedCapabilityId):null,i=t.inputs.map(e=>`${e.name} (${e.kind}${e.unreadable?` — not analyzed`:``})`),a=e.findings.length?e.findings.map(e=>`
      ...
      <div class="studio-result-card">
        ...
        ${this.bulletListMarkup(i,`No inputs were attached.`)}
        ...
        <p class="field-label" style="margin-top:14px;">Next actions</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioInspResearch">${u(`research`,13)} Research Further</button>
          <button type="button" class="ghost-btn" id="studioInspNewProject">${u(`plus`,13)} Create Project</button>
          ${n?`<button type="button" class="ghost-btn" id="studioInspOpenCapability" data-open-id="${n.id}">${u(n.icon,13)} Open ${Q(n.title)}</button>`:``}
        </div>

        <p class="field-label" style="margin-top:14px;">Continue this result</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioInspSendProblem">${u(`problem`,13)} Send to Problem Solver</button>
          <button type="button" class="ghost-btn" id="studioInspSaveKnowledge">${u(`knowledge`,13)} Save to Knowledge</button>
        </div>
      ...
      <div class="studio-ai-suggestions">
        <button type="button" class="ghost-btn small" id="studioInspAiAsk">${u(`ask`,13)} Get AI Assist</button>
...
`)){let e=a.trim();if(!e)continue;let o=e.replace(/:$/,``).toLowerCase();if(n[o]){r=n[o];continue}if(!r)continue;let s=e.replace(/^[-*•]\s*/,``).trim();s&&(r===`summary`?i.push(s):t[r].push(s))}return t.summary=i.length?i.join(` `):null,t}renderOptimizationWorkspace(e){this.activeWorkspace=`optimization`;let t=this.outputPanel.querySelector(`.stage`);if(!t)return;let n=this.lastOptimizationRaw,r=this.kernel.getProjectManager().getCurrentProject();t.innerHTML=`
      <div class="studio-workspace studio-workspace-wide">
        ...
        <div class="studio-workspace-header">
          <div>
            <div class="studio-workspace-title">${u(`optimization`,20)} MAGENAIS Intelligence — Optimization</div>
        ...
        <div class="studio-ps-actions">
          <button type="button" class="run-btn" id="studioOptAnalyze">${u(`optimization`,14)} Optimize</button>
      ...
      <div class="studio-result-card">
        ...
        ${this.bulletListMarkup(i,`No candidate options/strategies were supplied yet.`)}
        ...
        <div id="studioOptWhatIfHistory" style="margin-top:8px;">${o}</div>

        <div id="studioOptAiBlock">${this.optimizationAiBlockMarkup()}</div>

        <p class="field-label" style="margin-top:14px;">Next actions</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioOptResearch">${u(`research`,13)} Research Further</button>
          <button type="button" class="ghost-btn" id="studioOptNewProject">${u(`plus`,13)} Create Project</button>
          ${n?`<button type="button" class="ghost-btn" id="studioOptOpenCapability" data-open-id="${n.id}">${u(n.icon,13)} Open ${Q(n.title)}</button>`:``}
        </div>

        <p class="field-label" style="margin-top:14px;">Continue this result</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioOptSendProblem">${u(`problem`,13)} Send to Problem Solver</button>
          <button type="button" class="ghost-btn" id="studioOptSaveKnowledge">${u(`knowledge`,13)} Save to Knowledge</button>
        </div>
      ...
      <div class="studio-ai-suggestions">
        <button type="button" class="ghost-btn small" id="studioOptAiAsk">${u(`ask`,13)} Get AI Assist</button>
...
`)){let e=a.trim();if(!e)continue;let o=e.replace(/:$/,``).toLowerCase();if(n[o]){r=n[o];continue}if(!r)continue;let s=e.replace(/^[-*•]\s*/,``).trim();s&&(r===`summary`?i.push(s):t[r].push(s))}return t.summary=i.length?i.join(` `):null,t}renderKnowledgeWorkspace(){this.activeWorkspace=`knowledge`;let e=this.outputPanel.querySelector(`.stage`);if(!e)return;let t=this.kernel.getProjectManager(),n=t.getCurrentProject(),r=n?w(n,e=>this.kernel.getAssetManager().getAsset(e)):[],i=t.getProjects().filter(e=>e.id!==n?.id);e.innerHTML=`
        ...
        ${n?`
          <div class="studio-kn-project-bar">
            ...
            <div class="studio-ps-actions" style="margin:0;">
              <button type="button" class="ghost-btn small" id="studioKnSwitchProject">${u(`app`,12)} Switch</button>
              <button type="button" class="ghost-btn small" id="studioKnEditProject">${u(`text`,12)} Edit</button>
            </div>
          </div>
          ...
          <div class="studio-ps-actions">
            <button type="button" class="ghost-btn" id="studioKnAsk">${u(`ask`,13)} Ask About This Project</button>
            <button type="button" class="ghost-btn" id="studioKnFind">${u(`search`,13)} Find Information</button>
            <button type="button" class="ghost-btn" id="studioKnAddSource">${u(`plus`,13)} Add Source</button>
            <button type="button" class="ghost-btn" id="studioKnSummarize">${u(`text`,13)} Summarize Sources</button>
            <button type="button" class="ghost-btn" id="studioKnGaps">${u(`diagnosis`,13)} Identify Gaps</button>
            <button type="button" class="ghost-btn" id="studioKnOpenResearch">${u(`research`,13)} Open Research</button>
            <button type="button" class="ghost-btn" id="studioKnOpenDocuments">${u(`doc`,13)} Open Documents</button>
          </div>
        ...
        `:`
          <div class="studio-result-card studio-result-warn">
            ...
            ${i.length>0?`
              ...
              <div class="studio-mini-list">
                ${i.map(e=>this.knowledgeProjectRowMarkup(e)).join(``)}
              </div>`:``}
            <div class="studio-ps-actions" style="margin-top:14px;">
              <button type="button" class="run-btn" id="studioKnNewProject">${u(`plus`,14)} New Project</button>
            </div>
          </div>`}
      ...
      <div class="studio-source-item" title="Asset ID: ${Q(e.assetId)}">
        <span class="studio-mini-icon">${u(nn[e.typeLabel]||`app`,15)}</span>
        <span class="studio-source-main">
          ...
          <span class="studio-source-meta-row">
            ...
            ${e.assetType===`url`&&e.sourceUrl?`<a href="${Q(e.sourceUrl)}" target="_blank" rel="noopener noreferrer" class="studio-source-open">${u(`link`,11)} Open Source</a>`:``}
          </span>
        </span>
      ...
      <div class="studio-result-card">
        ...
        ${t===`url`?`
          ...
          <div class="studio-ps-actions">
            <button type="button" class="run-btn" id="studioKnSourceSubmit">${u(`plus`,14)} Add Source(s)</button>
          </div>
        `:t===`file`?`
        ...
        `:`
          ...
          <div class="studio-ps-actions">
            <button type="button" class="run-btn" id="studioKnSourceSubmit">${u(`plus`,14)} Add Source</button>
          </div>
        `}
      ...
      <div class="studio-ps-actions">
        <button type="button" class="run-btn" id="studioKnFileSubmit" ${!e||this.knowledgeFileExtracting?`disabled`:``}>${u(`plus`,14)} ${this.knowledgeFileExtracting?`Extracting…`:`Add Source`}</button>
      ...
      <div class="studio-result-card">
        ...
        <div class="studio-ps-actions" style="margin-top:10px;">
          <button type="button" class="ghost-btn small" id="studioKnNewProject2">${u(`plus`,13)} New Project</button>
        </div>
      ...
      <div class="studio-mini-row">
        ...
        <button type="button" class="studio-mini-delete" data-delete-project-id="${Q(e.id)}" data-delete-project-name="${Q(e.name)}" aria-label="Delete ${Q(e.name)}" title="Delete this project">${u(`trash`,13)}</button>
      ...
      <div class="studio-result-card">
        ...
        <div class="studio-ps-actions">
          <button type="button" class="run-btn" id="studioKnAskSubmit">${u(`ask`,14)} Ask</button>
        </div>
        ${e?this.knowledgeAnswerMarkup(e):``}
          ...
          </div>`).join(``):``,n=e.unknownNote?`<div class="studio-kn-statement">${this.knowledgeBadgeMarkup(`unknown`)}<p>${this.escapeHtml(e.unknownNote)}</p></div>`:``,i=e.suggestedCapabilityId?r.getById(e.suggestedCapabilityId):null;return`
      <div class="studio-kn-answer">
        ...
        ${i?`
          ...
          <div class="studio-ps-actions">
            <button type="button" class="ghost-btn" id="studioKnOpenSuggested" data-open-id="${i.id}">${u(i.icon,13)} Open ${this.escapeHtml(i.title)}</button>
          </div>`:``}
        <p class="field-label" style="margin-top:14px;">Continue this</p>
        <div class="studio-ps-actions">
          <button type="button" class="ghost-btn" id="studioKnSendProblem">${u(`problem`,13)} Send to Problem Solver</button>
          <button type="button" class="ghost-btn" id="studioKnSendDecision">${u(`decision`,13)} Send to Decision Intelligence</button>
        </div>
...
`)+a}}knowledgeAiBlockMarkup(){if(this.knowledgeAiLoading)return`<div class="studio-ai-suggestions"><p class="hint">Reading the relevant sources and asking the configured AI provider…</p></div>`;if(this.knowledgeAiAnswer){let e=this.knowledgeResolvedSources||[],t=e.filter(e=>e.status===`available`).length,n=e.length>0?`
        ...
        <div class="studio-source-list">
          ${e.map(e=>`
            <div class="studio-source-item">
              <span class="studio-mini-icon">${u(nn[e.source.typeLabel]||`app`,15)}</span>
              <span class="studio-source-main">
      ...
      <div class="studio-ai-suggestions">
        <button type="button" class="ghost-btn small" id="studioKnAiAsk" ${e?``:`disabled`}>${u(`ask`,13)} Get AI Answer</button>
      ...
      <div class="studio-result-card">
        ...
        <div class="studio-ask-row">
          ...
          <button type="button" class="ghost-btn small" id="studioKnFindSubmit">${u(`search`,13)}</button>
        </div>
